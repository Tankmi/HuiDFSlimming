package com.huidf.slimming.activity.user.perfect_info;
...
import com.huidf.slimming.fragment.user.perfect_info.GuidanceBirthdayFragment;
import com.huidf.slimming.fragment.user.perfect_info.GuidanceHeightFragment;
import com.huidf.slimming.fragment.user.perfect_info.GuidanceLoseWeightPeriodFragment;
import com.huidf.slimming.fragment.user.perfect_info.GuidanceSexFragment;
import com.huidf.slimming.fragment.user.perfect_info.GuidanceTargetWeightFragment;
import com.huidf.slimming.fragment.user.perfect_info.GuidanceWeightFragment;
...
public class PerfectInfoBaseActivity extends BaseFragmentActivity implements View.OnClickListener, GuidanceSexFragment.OnGuidanceSexListener {
    ...
    private android.support.v4.app.Fragment[] fragmentlists;
    private Fragment mFragment;

    private void initMFragments()
    {
        fragmentlists = new android.support.v4.app.Fragment[maxNum];
        pageNum = -1;
