package com.huidf.slimming.view.perfect_info;
...
//	initMonths(getYear());
	...
	protected void init() {
		View.inflate(context, R.layout.relativelayout_wheelview_birthday, BirthdayRelativelayoutWheelView.this);
		findView();
...
//		dismiss();
	...
	public void findView() {
		...
		wv_ad_year = findViewById(R.id.wv_ad_year);
		wv_ad_month = findViewById(R.id.wv_ad_month);
		wv_ad_day = findViewById(R.id.wv_ad_day);
